...
int main(){
	...
	char filename[6][11] = {"datasetA", "datasetA01", "datasetA02", "datasetA03", "datasetA04", "datasetA05"};
	//char filename[6][11] = {"datasetB", "datasetB01", "datasetB02", "datasetB03", "datasetB04", "datasetB05"};
