...
int main(int argc, char **argv) {
	...
	char filename1[10][11] = {"outputa01", "outputb01", "outputa02", "outputb02","outputa03", "outputb03", "outputa04", "outputb04", "outputa05", "outputb05"};

	int PPRLround = 0;
	for(int fround = 0; fround < 10; fround += 2){
		PPRLround++;
		FILE *fileA,*fileB;
